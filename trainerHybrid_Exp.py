            ...
            if type(out) is not tuple:
                ...
                if SAMPLE == "LUNGS":
                    ...
                    if config['experiment'] == 1 or config['experiment'] == 3:
                        out, pre1, pre2 = out
                        # HybridGNet with 2 skip connections
                        pre1loss = F.mse_loss(pre1[:,47:,:], target_down[:,47:,:])
                        pre2loss = F.mse_loss(pre2[:,94:,:], target[:,94:,:])
                        outloss = F.mse_loss(out[:,94:,:], target[:,94:,:])
...
if __name__ == "__main__":
    ...
    train_dataset_both = LandmarksDataset(images=images_train_L,
    ...
    val_dataset_both = LandmarksDataset(images=images_val_L,
                                     img_path="../Chest-xray-landmark-dataset/Images",
                                     label_path="../Chest-xray-landmark-dataset/landmarks",
                                     organ = 'LH',
                                     transform = ToTensor()
    ...
    train_dataset_one = LandmarksDataset(images=images_train_H,
                                     img_path="../Chest-xray-landmark-dataset/Images",
                                     label_path="../Chest-xray-landmark-dataset/landmarks",
                                     organ = 'LH',
                                     transform = transforms.Compose([
    ...
    val_dataset_one = LandmarksDataset(images=images_val_H,
                                     img_path="../Chest-xray-landmark-dataset/Images",
                                     label_path="../Chest-xray-landmark-dataset/landmarks",
                                     organ = 'LH',
                                     transform = ToTensor()
    ...
    trainer(train_dataset_both, val_dataset_both, train_dataset_one, val_dataset_one, model, config, DL_t)